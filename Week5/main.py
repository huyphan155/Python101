from logtool import ErrorLog
from dataclasses import asdict

from logtool.api_client import upload_log
from logtool import parse_log # public API ( in __init__.py )
from logtool.manager import LogManager
import json
